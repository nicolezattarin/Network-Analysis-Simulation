...
for gg in G:
    np.random.seed(0)
    throughput_6dB.append(GQRmulti_access(SIR_threshold=6, G=gg, sigma=8)['success_prob'])
    throughput_10dB.append(GQRmulti_access(SIR_threshold=10, G=gg, sigma=8)['success_prob'])
